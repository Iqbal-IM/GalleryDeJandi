...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        $query = mysqli_query($koneksi, "SELECT kategori.nama_kategori, COUNT(produk.nama_produk) AS jumlah FROM produk LEFT JOIN kategori ON produk.id_kategori=kategori.id_kategori GROUP BY produk.id_kategori");
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                                    Kategori (<?= $data->nama_kategori ?>)</div>
        ...
        <div class="col-xl-8 mb-4">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Mini Game</h6>
                </div>
                <div class="card-body">
                    <canvas id="ruang" width="610" height="500"></canvas>
