	...
	<div class="container">
		<div class="flex-w flex-sb-m p-b-52">
			<div class="flex-w flex-l-m filter-tope-group m-tb-10">
				...
				<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".tenun">
					Tenun
				</button>

				<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".fashion">
					Fashion
				</button>
			...
			<form class="form-inline">
				<label class="form-inline control-label p-r-10"> Sort by </label>
				<input type="hidden" name="m" value="product" />
				...
				<div class="form-group">
					<button class="btn btn-success"> <i class="fa fa-refresh"></i> Cari</button>
				</div>
			</form>
		...
		<div class="row isotope-grid">
			...
			<?php
			$query = mysqli_query($koneksi, "SELECT * FROM produk JOIN kategori ON kategori.id_kategori=produk.id_kategori WHERE nama_kategori='Tenun' ORDER BY id_produk");
			while ($row = mysqli_fetch_object($query)) { ?>
				<div class="col-6 col-md-4 col-lg-3 p-b-35 isotope-item tenun">
					<!-- Block2 -->
					<div class="block2">
						<div class="block2-pic hov-img0">
							<a href="?m=product-detail&id_produk=<?= $row->id_produk ?>">
			...
			<?php
			$query = mysqli_query($koneksi, "SELECT * FROM produk JOIN kategori ON kategori.id_kategori=produk.id_kategori WHERE nama_kategori='Fashion' ORDER BY id_produk");
			while ($row = mysqli_fetch_object($query)) { ?>
				<div class="col-6 col-md-4 col-lg-3 p-b-35 isotope-item fashion">
					<!-- Block2 -->
					<div class="block2">
						<div class="block2-pic hov-img0">
							<a href="?m=product-detail&id_produk=<?= $row->id_produk ?>">
			...
			<div class="col-6 col-md-4 col-lg-3 p-b-35 isotope-item shoes">
				<!-- Block2 -->
				<div class="block2">
					<div class="block2-pic hov-img0">
